...
public class Projet2 extends projet1 implements ActionListener, WindowListener,
	...
	public Projet2() {
		...
		sliderLabel11.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel1 = new JLabel(" Claqué", JLabel.LEFT);
		sliderLabel1.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel6 = new JLabel(" ClaquéFrequence", JLabel.CENTER);
		sliderLabel6.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel2 = new JLabel(" Tonique", JLabel.CENTER);
		sliderLabel2.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel7 = new JLabel(" ToniqueFrequence", JLabel.CENTER);
		sliderLabel2.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel3 = new JLabel(" Bass", JLabel.CENTER);
		sliderLabel3.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel8 = new JLabel(" BassFrequence", JLabel.CENTER);
		sliderLabel8.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel4 = new JLabel(" MatéClaqué", JLabel.CENTER);
		sliderLabel4.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel9 = new JLabel(" MatéClaquéFrequence", JLabel.CENTER);
		sliderLabel4.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel5 = new JLabel(" MatéTonique", JLabel.CENTER);
		sliderLabel5.setAlignmentX(Component.CENTER_ALIGNMENT);

		JLabel sliderLabel10 = new JLabel("MatéToniqueFrequence", JLabel.CENTER);
		sliderLabel10.setAlignmentX(Component.CENTER_ALIGNMENT);
